...
function genRuns() {
    ...
    for (var i = cnt - 1; i >= max; i--) {
        ...
        var s = '<li data-theme="' + (r.isDnf ? 'a' : r.getRerun ? 'e' : '') + '"><a id="run-' + r.runNumber + '-' + r.driverId + '">'
            ...
            + '<p class="ui-li-desc">' +  r.car.description + '<br>Cones: <strong>' + r.cones + '</strong>, PAX: <strong>' + r.timepaxed + '</strong><br></p><span class="ui-li-count">Run ' + r.runNumber + ' of 4</span>';
        if (r.isDnf) {
